...
Se você fizer alguma modificação no código acima, pode observar o impacto dessas modificações no quadro abaixo. Sugiro que modifique as regras de transição e veja o impacto dessas mudanças no comportamento do jogo.

A representação a seguir do Jogo da Vida foi implementada utilizando WebGL (caso ela se encontre "travada", recarregue a página ou troque de navegador).

---

## Origem e Curiosidades

What follows from here is just a bunch of absolute nonsense I've written to dogfood the plugin itself. It includes every sensible typographic element I could think of, like __bold text__, unordered lists, ordered lists, code blocks, block quotes, _and even italics_.
